...
export const BOSS_FIGHTS: BossData[] = [
  {
    ...
    "bossDrops": [
      "A clean, analysis-ready dataset that all future weeks will use",
      "A preprocess.py script you can plug into any pipeline",
      "The habit of always explaining what you see."
    ],
    "xpReward": 520,
    "dailyTasks": [
      {
